    ...
    <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="heading2" id="title" value="{!! $data->heading2 !!}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="linktext1" id="linktext1" value="{!! $data->linktext1 !!}">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
        ...
        <div class="third-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" class="form-control image-upload dropify" id="aboutimage2"
                                name="aboutimage2" data-default-file="{{ Storage::url($data->aboutimage2) }}" accept="image/*">
                        </div>
                        <div class="col-md-12 mt-1">
                            <label for="trustednos">Trusted Customers Nos:</label>
                            <input class="form-control" type="text" name="trustednos" id="trustednos"value="{!! $data->trustednos !!}">
                        </div>
                        <div class="col-md-12 mt-1">
                            <label for="aboutheading">About Heading:</label>
                            <input class="form-control" type="text" name="heading3" id="heading3"value="{!! $data->heading3 !!}">
                        </div>
                        ...
                        <div class="vision row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group vision-input mt-1">
                                    <input type="text" class="form-control" placeholder="Vision" name="visions[]" value="{{ $vision }}">
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-danger removeVision btn-sm m-1"><i class="fa fa-times" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                @endforeach
                                <button type="button" class="btn btn-success addVision btn-sm mt-1">Add New <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                            </div>
                        </div>
                        <div class="mission row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mission-input mt-1">
                                    <input type="text" class="form-control" placeholder="Mission" name="missions[]" value="{{$mission}}">
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-danger removeMission btn-sm m-1"><i class="fa fa-times" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                @endforeach
                                <button type="button" class="btn btn-success addMission btn-sm mt-1">Add New <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="features-section">
                        ...
                        <!-- Display input fields for each feature in the $features array -->
                            ...
                            <div class="feature row mt-1">
                                ...
                                <div class="form-group col-md-4 mt-1">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Feature" name="featureheadings[]" value="{{ $index }}">
                                    </div>
                                </div>
                                <div class="form-group col-md-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Feature Description" name="featuredescriptions[]" value="{{ $feature }}">
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-danger removeFeature btn-sm m-1"><i class="fa fa-times" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                ...
                <button type="button" class="btn btn-success addFeature btn-sm mt-1">Add New<i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="file" class="form-control image-upload dropify" id="serviceimage1"
                                    name="serviceimage1" data-default-file="{{ Storage::url($data->serviceimage1) }}" accept="image/*">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" class="form-control image-upload dropify" id="serviceimage2"
                                            name="serviceimage2" data-default-file="{{ Storage::url($data->serviceimage2) }}" accept="image/*">
                        </div>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input class="form-control" type="text" name="serviceheading1" id="serviceheading1" value="{!! $data->serviceheading1 !!}">
                        </div>
                            ...
                            <div class="services row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group service-input mt-1">
                                        <input type="text" class="form-control" placeholder="Service" name="services[]" value="{{ $service }}">
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-danger removeService btn-sm m-1"><i class="fa fa-times" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                                    @endforeach
                                    <button type="button" class="btn btn-success addService btn-sm mt-1">Add New <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-1">
                            <label for="serviceheading">Button Link URL:</label>
                            <input class="form-control" type="text" name="servicelink" id="servicelink" value="{!! $data->servicelink !!}">
                        </div>
                        <div class="col-12 mt-1">

                            <div class="col-md-12">
                                <label for="serviceheading">Service Left Heading:</label>
                                <input class="form-control" type="text" name="serviceheading2" id="serviceheading2" value="{!! $data->serviceheading2 !!}">
                            </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input class="form-control" type="text" name="productnos" id="productnos" value="{!! $data->productnos !!}">
                                    </div>
                                    <div class="col-6">
                                        <label for="satisfaction">Satisfaction %:</label>
                                        <input class="form-control" type="text" name="satisfaction" id="satisfaction" value="{!! $data->satisfaction !!}">
                                    </div>
        ...
        <div class="fifth-section">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <input type="file" class="form-control image-upload dropify" id="advimage"
                            name="advimage" data-default-file="{{ Storage::url($data->advimage) }}" accept="image/*">
                </div>
                <div class="col-md-7">
                    <div class="form-group">
                        <label for="advantageheading">Advantage Heading:</label>
                        <input class="form-control" type="text" name="advheading" id="advheading" value="{!! $data->advheading !!}">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-9">
                            ...
                            <input class="form-control" type="text" name="testheading" id="testheading" value="{!! $data->testheading !!}">
                        </div>
                        <div class="form-group col-3 mt-1">
                        <a href="{{ route('admin.testimonials.index')}}" class="btn btn-primary mt-3">Manage Testimonials</a>
                        </div>
