...
function Le(e, n, t) {
    return (
        e &&
            (t ? Be(e).reverse() : Be(e)).forEach(function (r) {
                r !== "__proto__" && n(e[r], r);
            }),
        e
    );
...
function We(e) {
    return (
        _e(arguments, 1).forEach(function (n) {
            Le(n, function (t, r) {
                e[r] = n[r];
            });
        }),
...
function re(e, n, t) {
    if (qe(t)) return getComputedStyle(e)[n];
    Pt(t) || (e.style[n] = "" + t);
}
function He(e, n) {
    re(e, "display", n);
    ...
    function n(i, s, c, v) {
        o(i, s, function (a, m, d) {
            var g = "addEventListener" in a,
                u = g
                    ? a.removeEventListener.bind(a, m, c, v)
                    : a.removeListener.bind(a, c);
    ...
    function r(i, s, c) {
        ...
        return (
            typeof CustomEvent == "function"
                ? (v = new CustomEvent(s, { bubbles: a, detail: c }))
...
function H(e) {
    ...
    return (
        e && e.event.on(_n, t.destroy),
        We(t, { bus: n, on: r, off: U(t.unbind, n), emit: o })
    );
}
function dt(e, n, t, r) {
    var o = Date.now,
    ...
    return { start: m, rewind: g, pause: d, cancel: u, set: f, isPaused: _ };
}
function ir(e) {
    var n = e;
    function t(o) {
...
function or(e, n, t) {
    ...
    function d(u) {
        matchMedia($t).matches && (u ? Ee(t, l) : jt(t, Be(l)));
    }
    function g(u, f, _) {
        Ee(t, u),
    ...
    return { setup: c, destroy: v, reduce: d, set: g };
}
var gt = "Arrow",
    Et = gt + "Left",
    ht = gt + "Right",
...
function ur(e, n, t) {
    function r(l, i, s) {
        ...
        return (
            (Tt[l] && Tt[l][c]) ||
            l.replace(/width|left|right/i, function (v, a) {
...
var le = "role",
    ...
    rn = ae + "busy",
    an = ae + "atomic",
    Bt = [le, we, sr, tt, bn, te, zt, Dn, Ut, Ke],
    se = Qe + "__",
    ye = "is-",
    St = Qe,
    on = se + "track",
...
function _r(e, n) {
    if (fn(e.closest)) return e.closest(n);
    for (var t = e; t && t.nodeType === 1 && !Ue(t, n); ) t = t.parentElement;
    return t;
}
var yr = 5,
    un = 200,
...
function Tr(e, n, t) {
    ...
    function A(T) {
        ...
        de(v), ve(i, a), ve(d, m), ue([d, g], b), ue(i, T ? b : ["style", Ke]);
    }
    function h() {
        ve(i, a),
            ve(d, m),
    ...
    function E() {
        (d = O("." + on)),
            ...
            We(c, { root: i, track: d, list: g, slides: v });
    }
    function P() {
        var T = i.id || Hn(Qe),
            b = t.role;
    ...
    return We(c, { setup: f, mount: _, destroy: A });
}
var pe = "slide",
    xe = "loop",
    nt = "fade";
function Sr(e, n, t, r) {
    ...
    function I() {
        var C = F();
        C !== Zt(r, Ne) &&
            (fe(r, Ne, C), x(r, bn, (m && C) || ""), i(C ? Yn : Xn, p));
    }
    function N() {
        var C = Y(),
            S = !C && (!F() || E);
        if (
            (e.state.is([Me, $e]) || x(r, Dn, S || ""),
            x(Vt(r, a.focusableNodes || ""), we, S ? -1 : ""),
            f && x(r, we, S ? -1 : 0),
            C !== Zt(r, Dt) && (fe(r, Dt, C), i(C ? Kn : $n, p)),
    ...
    function W(C, S) {
        var D = J(C - n);
        return (
            !E && (a.rewind || e.is(xe)) && (D = me(D, e.length - D)), D <= S
        );
    }
    var p = {
        index: n,
...
function Ir(e, n, t) {
    var r = H(e),
        ...
        A;
    function h() {
        E(), l(window, "resize load", ar(U(i, Xe))), o([Q, K], E), o(Xe, P);
    }
    function E() {
        (f = t.direction === mt),
            re(a, "maxWidth", Se(t.width)),
    ...
    function P(p) {
        var C = ee(a);
        (p || _.width !== C.width || _.height !== C.height) &&
            (re(m, "height", M()),
            u(c("marginRight"), Se(t.gap)),
            u("width", b()),
            u("height", G(), !0),
            (_ = C),
            i(Gt),
            A !== (A = W()) && (fe(a, Fn, A), i(Jn, A)));
    }
    function O(p) {
        var C = t.padding,
            S = c(p ? "right" : "left");
...
function Rr(e, n, t) {
    var r = H(e),
        ...
        v;
    function a() {
        o(K, m), o([Q, Xe], g), (v = _()) && (u(v), n.Layout.resize(!0));
    }
    function m() {
        d(), a();
    }
    ...
    function u(A) {
        var h = i.get().slice(),
            E = h.length;
        if (E) {
            for (; h.length < A; ) at(h, h);
            at(h.slice(-A), h.slice(0, A)).forEach(function (P, O) {
                var M = O < A,
                    T = f(P.slide, O);
                M ? Mt(T, h[0].slide) : Ze(l.list, T),
                    at(c, T),
                    i.register(T, O - A + (M ? 0 : E), P.index);
            });
        }
    }
    function f(A, h) {
        var E = A.cloneNode(!0);
        return (
            oe(E, t.classes.clone), (E.id = e.root.id + "-clone" + Ft(h + 1)), E
        );
    }
    function _() {
        var A = t.clones;
...
function Or(e, n, t) {
    var r = H(e),
        ...
        E;
    function P() {
        (E = n.Transition), o([Re, Gt, Q, K], O);
    }
    function O() {
        n.Controller.isBusy() ||
            (n.Scroll.cancel(), T(e.index), n.Slides.update());
    }
    function M(S, D, k, q) {
        S !== D && p(S > k) && (L(), b(w(V(), S > k), !0)),
            i(Me),
            l(Ae, D, k, S),
            E.start(D, function () {
                i(Pe), l(et, D, k, S), q && q();
    ...
    function I(S) {
        for (
            var D = n.Slides.get(), k = 0, q = 1 / 0, $ = 0;
            $ < D.length;
            $++
        ) {
            var ge = D[$].index,
...
function br(e, n, t) {
    ...
    function G() {
        (O = d(!0)), (M = t.perMove), (T = t.perPage), (E = p());
    ...
    function V(y, z) {
        var Z = M || ($() ? 1 : T),
            X = F(h + Z * (y ? -1 : 1), h, !(M || $()));
        return X === -1 && f && !hn(s(), c(!y), 1) ? (y ? 0 : E) : z ? X : W(X);
    }
    function F(y, z, Z) {
        if (m() || $()) {
            var X = Y(y);
    ...
    function Y(y) {
        if (f && t.trimSpace === "move" && y !== h)
            for (
                var z = s();
                z === v(y, !0) && ot(y, 0, e.length - 1, !t.rewind);
...
function wr(e, n, t) {
    ...
    function O() {
        ...
        I && !(u && f) && G(),
            u &&
                ...
                I && (T(), L(), x([u, f], tt, d.id), i(Qn, u, f)));
    }
    function M() {
        r.destroy(),
            ve(g, A),
            _ ? (Ie(m ? [u, f] : g), (u = f = null)) : ue([u, f], Bt);
    }
    function T() {
        o([Re, et, K, Ve, vt], L),
            l(f, "click", U(b, ">")),
    ...
    return { arrows: h, mount: E, destroy: M, update: L };
}
var Pr = xt + "-interval";
function pr(e, n, t) {
    var r = H(e),
        ...
        _ = g === "pause";
    function A() {
        g && (h(), d && x(d, tt, v.track.id), _ || E(), M());
    }
    function h() {
        t.pauseOnHover &&
            l(m, "mouseenter mouseleave", function (G) {
                (u = G.type === "mouseenter"), O();
            }),
            t.pauseOnFocus &&
                l(m, "focusin focusout", function (G) {
                    (f = G.type === "focusin"), O();
                }),
            d &&
                l(d, "click", function () {
    ...
    function E() {
        c() &&
            n.Slides.isEnough() &&
            (s.start(!t.resetProgress), (f = u = _ = !1), M(), i(Tn));
    }
    function P(G) {
    ...
    return { mount: A, destroy: s.cancel, play: E, pause: P, isPaused: c };
}
function Mr(e, n, t) {
    var r = H(e),
        o = r.on;
    ...
    function s(c, v, a) {
        a.style(
            "background",
            c ? 'center/cover no-repeat url("' + v.src + '")' : "",
            !0
        ),
            He(v, c ? "none" : "");
    }
    return { mount: l, destroy: U(i, !1) };
}
var Vr = 10,
    xr = 600,
    Fr = 0.6,
...
function zr(e, n, t) {
    ...
    function A(T, b, G, w, L) {
        ...
        var F = hn(I, T, 1);
        (f = 1),
            (b = F ? 0 : b || ct(J(T - I) / Gr, kr)),
            (u = w),
            (g = dt(b, h, U(E, I, T, L), 1)),
            i($e),
            l(kt),
            g.start();
    }
    ...
    return { mount: _, destroy: P, scroll: A, cancel: O };
}
...
function Ur(e, n, t) {
    ...
    return { mount: I, disable: Xt, isDragging: kn };
}
var Br = { Spacebar: " ", Right: ht, Left: Et, Up: Rn, Down: On };
function Ht(e) {
...
function Wr(e, n, t) {
    ...
    return { mount: m, destroy: g, disable: u };
}
var ke = xt + "-lazy",
    ut = ke + "-srcset",
    Hr = "[" + ke + "], [" + ut + "]";
function Yr(e, n, t) {
    ...
    function g() {
        n.Slides.forEach(function (h) {
            Vt(h.slide, Hr).forEach(function (E) {
                var P = ie(E, ke),
                    O = ie(E, ut);
                if (P !== E.src || O !== E.srcset) {
                    var M = t.classes.spinner,
                        T = E.parentElement,
                        b = Je(T, "." + M) || Ce("span", M, T);
                    a.push([E, h, b]), E.src || He(E, "none");
                }
            });
        });
    }
    ...
    function _(h, E) {
        var P = h[0],
            O = h[1];
        ve(O.slide, Ct),
            E.type !== "error" && (Ie(h[2]), He(P, ""), s(Ln, P, O), s(Xe)),
            c && A();
    }
    function A() {
        a.length && f(a.shift());
    }
    return { mount: m, destroy: U(de, a), check: u };
}
function Xr(e, n, t) {
    var r = H(e),
        o = r.on,
    ...
    function h() {
        ...
        u && He(u, w ? "" : "none"),
            w &&
                ...
                P(),
                G(),
                l(tr, { list: _, items: f }, b(e.index)));
    }
    function E() {
        _ && (Ie(u ? _e(_.children) : _), ve(_, A), de(f), (_ = null)),
            r.destroy();
    }
    function P() {
        var w = e.length,
            ...
            I = t.i18n,
            N = t.perPage,
            V = a() ? v.getEnd() + 1 : Ye(w / N);
        (_ = u || Ce("ul", L.pagination, c.track.parentElement)),
            oe(_, (A = yt + "--" + T())),
            x(_, le, "tablist"),
            x(_, te, I.select),
            x(_, Ut, T() === mt ? "vertical" : "");
        for (var F = 0; F < V; F++) {
            var Y = Ce("li", null, _),
                W = Ce("button", { class: L.page, type: "button" }, Y),
                p = s.getIn(F).map(function (S) {
                    return S.slide.id;
                }),
    ...
    function G() {
        ...
        l(nr, { list: _, items: f }, w, L);
    }
    return { items: f, mount: h, destroy: E, getAt: b, update: G };
}
var Kr = [" ", "Enter"];
function $r(e, n, t) {
    ...
    function a() {
        var u = H(e),
            f = u.on;
        f(An, d), f(In, g), f([Re, Q], m), l.push(u), u.emit(yn, e.splides);
    }
    function m() {
    ...
    return {
        setup: U(n.Media.set, { slideFocus: qe(o) ? r : o }, !0),
        mount: i,
        destroy: s,
        remount: c,
    };
...
function Zr(e, n, t) {
    ...
    function a(g) {
        x(l, rn, g), g ? (Ze(l, s), c.start()) : (Ie(s), c.cancel());
    }
    function m() {
        ue(l, [nn, an, rn]), Ie(s);
    }
    function d(g) {
        i && x(l, nn, g ? "off" : "polite");
    }
    return { mount: v, disable: d, destroy: m };
}
...
function ti(e, n, t) {
    ...
    return { mount: o, start: i, cancel: Nt };
}
function ni(e, n, t) {
    var r = n.Move,
        o = n.Controller,
    ...
    function d(g) {
        ...
        if (e.is(pe) && u) {
            var f = o.getIndex(!0),
                _ = o.getEnd();
            if ((f === 0 && g >= _) || (f >= _ && g === 0)) return u;
        }
        return t.speed;
    }
    return { mount: v, start: a, cancel: m };
}
var ri = (function () {
        function e(t, r) {
            (this.event = H()),
            ...
            Ge(o, o + " is invalid."),
                (this.root = o),
                (r = Ee(
                    { label: ie(o, te) || "", labelledby: ie(o, zt) || "" },
                    ei,
                    e.defaults,
                    r || {}
                ));
        ...
        return (
            (n.mount = function (r, o) {
                ...
                Ge(i.is([De, st]), "Already mounted!"),
                    ...
                    (this._E = r || this._E);
                var c = We({}, Jr, this._E, { Transition: this._T });
                return (
                    Le(c, function (v, a) {
                        var m = v(l, s, l._o);
            ...
            (n.emit = function (r) {
                var o;
                return (
                    (o = this.event).emit.apply(
                        o,
                        [r].concat(_e(arguments, 1))
                    ),
                    this
                );
            }),
            ...
            (n.destroy = function (r) {
                ...
                return (
                    l.is(De)
                        ? H(this).on(Qt, this.destroy.bind(this, r))
                        : (Le(
                              this._C,
                              function (i) {
...
Yt.defaults = {};
Yt.STATES = Wn;
new Yt(".splide", { type: "loop", perPage: 1, autoplay: !0 }).mount();
